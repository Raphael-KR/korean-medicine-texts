...
- Modern input note: 원본에 한글 음훈 주석 및 한자 사이 한글 혼입이 있음. 원문대조 전 임의 삭제·교정하지 않고 보존함.
- Quality status: `raw_converted`
- Converted at: `2026-09-16T16:42:14.929599+00:00`
- Conversion tool: `rhwp v0.7.12`

## 검증과 원문대조 상태

- 메타데이터: [metadata.json](metadata.json)
- 파생 청크: [chunks.jsonl](chunks.jsonl) — 790개, `paragraph-fallback-v1`
- 원문대조 목록: [collation.md](collation.md) — 한글 주석·혼입 438행
